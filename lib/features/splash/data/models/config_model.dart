...
abstract class AcceptedImageExtensionArray with _$AcceptedImageExtensionArray {
  const AcceptedImageExtensionArray._();
    const factory AcceptedImageExtensionArray({
        required String key,
        required String value,
    }) = _AcceptedImageExtensionArray;
    ...
    AcceptedImageExtensionArrayEntity toEntity() {
      return AcceptedImageExtensionArrayEntity(
        key: key,
        value: value,
      );
    }
...
abstract class ActivePaymentMethodList with _$ActivePaymentMethodList {
  const ActivePaymentMethodList._();
    const factory ActivePaymentMethodList({
        required String gateway,
        required String gatewayTitle,
        required String gatewayImage,
    ...
    ActivePaymentMethodListEntity toEntity() {
      return ActivePaymentMethodListEntity(
        gateway: gateway,
...
abstract class MaintenanceMessages with _$MaintenanceMessages {
  const MaintenanceMessages._();  
    ...
    const factory MaintenanceMessages({
        required int businessNumber,
        required int businessEmail,
        required String maintenanceMessage,
        required String messageBody,
    }) = _MaintenanceMessages;
    ...
    MaintenanceMessagesEntity toEntity() {
      return MaintenanceMessagesEntity(
...
abstract class MaintenanceTypeAndDuration with _$MaintenanceTypeAndDuration {
  const MaintenanceTypeAndDuration._();  
    ...
    MaintenanceTypeAndDurationEntity toEntity() {
      return MaintenanceTypeAndDurationEntity(
...
abstract class SelectedMaintenanceSystem with _$SelectedMaintenanceSystem {
  const SelectedMaintenanceSystem._();  
    ...
    const factory SelectedMaintenanceSystem({
        required int branchPanel,
        required int customerApp,
        required int webApp,
        required int deliverymanApp,
    }) = _SelectedMaintenanceSystem;
    ...
    SelectedMaintenanceSystemEntity toEntity() {
      return SelectedMaintenanceSystemEntity(
        branchPanel: branchPanel,
        customerApp: customerApp,
        webApp: webApp,
        deliverymanApp: deliverymanApp,
      );
    }
}
...
abstract class CookiesManagement with _$CookiesManagement {
  const CookiesManagement._();
    const factory CookiesManagement({
        required int status,
    ...
    CookiesManagementEntity toEntity() {
      return CookiesManagementEntity(
        status: status,
        text: text,
      );
    }
...
abstract class CustomerLogin with _$CustomerLogin {
  const CustomerLogin._();
    const factory CustomerLogin({
        required LoginOption loginOption,
        required SocialMediaLoginOptions socialMediaLoginOptions,
    }) = _CustomerLogin;
    ...
    CustomerLoginEntity toEntity() {
      return CustomerLoginEntity(
        loginOption: loginOption.toEntity(),
        socialMediaLoginOptions: socialMediaLoginOptions.toEntity(),
      );
    }
}
...
abstract class SocialMediaLoginOptions with _$SocialMediaLoginOptions {
  const SocialMediaLoginOptions._();
    ...
    const factory SocialMediaLoginOptions({
        required int google,
        required int facebook,
        required int apple,
    }) = _SocialMediaLoginOptions;
    ...
    SocialMediaLoginOptionsEntity toEntity() {
      return SocialMediaLoginOptionsEntity(
        google: google,
        facebook: facebook,
        apple: apple,
      );
...
abstract class CustomerVerification with _$CustomerVerification {
  const CustomerVerification._();
    const factory CustomerVerification({
        required int status,
        required int phone,
        required int email,
...
abstract class DeliveryManagement with _$DeliveryManagement {
  const DeliveryManagement._();
    const factory DeliveryManagement({
        required int status,
        required int minShippingCharge,
        required int shippingPerKm,
    }) = _DeliveryManagement;
    ...
    DeliveryManagementEntity toEntity() {
      return DeliveryManagementEntity(
        status: status,
        minShippingCharge: minShippingCharge,
        shippingPerKm: shippingPerKm,
      );
    }
}
...
abstract class DigitalPaymentInfo with _$DigitalPaymentInfo {
  const DigitalPaymentInfo._();
    const factory DigitalPaymentInfo({
        required String digitalPayment,
        required String pluginPaymentGateways,
        required String defaultPaymentGateways,
    }) = _DigitalPaymentInfo;
    ...
    DigitalPaymentInfoEntity toEntity() {
      return DigitalPaymentInfoEntity(
        digitalPayment: digitalPayment,
        pluginPaymentGateways: pluginPaymentGateways,
        defaultPaymentGateways: defaultPaymentGateways,
      );
    }
}
...
abstract class RestaurantLocationCoverage with _$RestaurantLocationCoverage {
  const RestaurantLocationCoverage._();
    const factory RestaurantLocationCoverage({
        required String longitude,
        required String latitude,
        required int coverage,
    ...
    RestaurantLocationCoverageEntity toEntity() {
      return RestaurantLocationCoverageEntity(
        longitude: longitude,
        latitude: latitude,
        coverage: coverage,
      );
...
abstract class RestaurantScheduleTime with _$RestaurantScheduleTime {
  const RestaurantScheduleTime._();
    const factory RestaurantScheduleTime({
        required int day,
    ...
    RestaurantScheduleTimeEntity toEntity() {
      return RestaurantScheduleTimeEntity(
        day: day,
